...
struct ConverterDispatchWorkgroupInfoPattern final
...
struct InlineConstantWorkgroupSizePattern
  ...
  LogicalResult matchAndRewrite(IREE::HAL::InterfaceWorkgroupSizeOp sizeOp,
    ...
    rewriter.replaceOpWithNewOp<mlir::ConstantOp>(sizeOp, dimAttr,
...
static LogicalResult convertFlowInfoOps(IREE::HAL::ExecutableOp executableOp) {
  ...
  patterns.insert<
      ConverterDispatchWorkgroupInfoPattern<IREE::Flow::DispatchWorkgroupIDOp,
 ...
 public:
  ...
  void runOnOperation() override {
    ...
    for (auto sourceOp : sourceOps) {
      ...
      // versions.
      convertFlowInfoOps(executableOp);

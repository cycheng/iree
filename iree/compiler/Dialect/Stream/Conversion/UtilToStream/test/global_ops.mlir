...
// CHECK: util.global public mutable @var_i32_size : index
...
func @mutableGlobal() {
  ...
  // CHECK-DAG: %[[SIZE:.+]] = util.global.load @var_i32_size : index
  ...
  // CHECK-DAG: util.global.store %[[SIZE]], @var_i32_size : index
...
//  CHECK-DAG: util.global public mutable @var_with_tensor_initializer_size : index
...
//  CHECK-DAG:   util.global.store %[[SIZE]], @var_with_tensor_initializer_size : index
...
func @initializedGlobal() {
  ...
  // CHECK-DAG: = util.global.load @var_with_tensor_initializer_size : index
  ...
  // CHECK-DAG: util.global.store %{{.+}}, @var_with_tensor_initializer_size : index
...
// CHECK-DAG: util.global public mutable @var_with_buffer_view_store_size : index
...
func @globalStoreFromExternal(%arg0: !hal.buffer_view) {
  ...
  // CHECK: util.global.store %[[SIZE]], @var_with_buffer_view_store_size : index

...
#ifndef IREE_COMPILER_DIALECT_STREAM_ANALYSIS_PARTITIONING_
#define IREE_COMPILER_DIALECT_STREAM_ANALYSIS_PARTITIONING_
...
PartitionSet partitionWaves(IREE::Stream::PartitioningConfigAttr config,
                            Block *block);
...
PartitionSet partitionWavesReference(
    IREE::Stream::PartitioningConfigAttr config, Block *block);
...
#endif  // IREE_COMPILER_DIALECT_STREAM_ANALYSIS_PARTITIONING_
